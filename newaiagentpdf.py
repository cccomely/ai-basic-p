...
pdfmetrics.registerFont(TTFont('NotoSerifSC', 'SourceHanSerifCN-Regular.ttf'))   # 宋体风格
pdfmetrics.registerFont(TTFont('NotoSansSC', 'SourceHanSansCN-Regular.ttf'))    # 黑体风格
import ollama as oa
